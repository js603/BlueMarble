...
export const PlanModal: FC<PlanModalProps> = ({ onConfirm }) => {
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {[2, 3, 4, 5].map(num => (
                      <button
                        ...
                        className={`py-3 rounded-xl font-bold transition-all border-2 flex flex-col items-center justify-center gap-1 ${localPlayerCount === num
