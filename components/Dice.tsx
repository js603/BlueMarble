<<<<<<< codex/fix-bugs-and-update-game
...
=======
  ...
  useEffect(() => {
    let isMounted = true;
    const init = async () => {
      const [{ Scene, PerspectiveCamera, WebGLRenderer, Color, Mesh, BoxGeometry, MeshStandardMaterial, AmbientLight, DirectionalLight, PlaneGeometry, MeshBasicMaterial, CanvasTexture, Vector3, Quaternion }, CANNON] = await Promise.all([
